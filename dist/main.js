...
c.setAttribute("class", "popup__title");
const o = document.createElement("p");
o.setAttribute("class", "popup__message");
const C = document.createElement("button");
C.setAttribute("class", "popup__close-btn");
s.appendChild(n);
s.appendChild(c);
s.appendChild(o);
s.appendChild(C);
...
const b = (l) => {
  let { title: u, message: d, level: r, button: p } = l;
  if (!u || !d)
  ...
  C.innerText = p || "Close", c.innerText = u, o.innerText = d, s.setAttribute("class", `popup popup--${r.toLowerCase()} popup--show`);
};
